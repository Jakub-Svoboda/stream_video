...
class Video(models.Model):
    ...
    iconUri = models.URLField(max_length=2000, validators=[URLValidator()])
    manifestUri = models.URLField(max_length=2000, validators=[URLValidator()])
    source = models.CharField(max_length=255)
    focus = models.BooleanField(default=False)
    disabled = models.BooleanField(default=False)
    extraText = models.JSONField(default=list)
    certificateUri = models.URLField(max_length=2000, null=True, blank=True, validators=[URLValidator()])
    ...
    adTagUri = models.URLField(max_length=2000, null=True, blank=True, validators=[URLValidator()])
